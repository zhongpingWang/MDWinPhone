...
namespace cn.jpush.api.util
{
    public class JsonTool
    {
        ...
        {           
            ...
            return Encoding.UTF8.GetString(dataBytes,0,dataBytes.Length).Replace("\\","");        
        }
        ...
        {
            List<ReceivedResult.Received> jsonclassList = JsonConvert.DeserializeObject<List<ReceivedResult.Received>>(jsonString);
